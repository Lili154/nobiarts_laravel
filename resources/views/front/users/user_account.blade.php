            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login-wrapper">
                        <h2 class="account-h2 u-s-m-b-20" style="font-size: 24px;color:#792D89" >Update Contact Details</h2>
                        ...
                        <form id="accountForm" action="javascript:;" method="post"> {{-- We need to deactivate the 'action' HTML attribute (using    'javascript:;'    ) as we'r going to submit using an AJAX call. Check front/js/custom.js --}}
                            ...
                            <div class="m-b-45">
                                <button class="button button-outline-secondary w-100" style="border:2px solid#792D89">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="reg-wrapper">
                        <h2 class="account-h2 u-s-m-b-20" style="font-size: 24px;color:#792D89">Update Password</h2>
                        ...
                        <form id="passwordForm" action="javascript:;" method="post"> {{-- We need to deactivate the 'action' HTML attribute (using    'javascript:;'    ) as we'r going to submit using an AJAX call. Check front/js/custom.js --}}
                            ...
                            <div class="u-s-m-b-45">
                                <button class="button button-primary w-100" style="background-color:#792D89">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
