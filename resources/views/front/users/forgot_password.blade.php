            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="login-wrapper">
                        <h2 class="account-h2 u-s-m-b-20">@lang('public.forgot password?')</h2>
                                ...
                                <div class="group-2 text-right">
                                    <div class="page-anchor">
                                        <a href="{{ url('user/login-register') }}">
                                            <i class="fas fa-circle-o-notch u-s-m-r-9"></i>@lang('public.back to login')
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="m-b-45">
                                <button type="submit" class="button button-outline-secondary w-100">@lang('public.submit')</button>
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="reg-wrapper">
                        ...
                        <form id="registerForm" action="javascript:;" method="post"> {{-- We need to deactivate the 'action' HTML attribute (using    'javascript:;'    ) as we'r going to submit using an AJAX call. Check front/js/custom.js --}}
                            ...
                            <div class="u-s-m-b-45">
                                <button class="button button-primary w-100">@lang('public.register')</button>
                            </div>
                        </form>
                    </div>
                </div>
