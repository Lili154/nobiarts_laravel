    ...
    <div class="container">
        ...
        <div class="outer-footer-wrapper u-s-p-y-80">
            ...
            <form class="newsletter-form">
                ...
                <input type="text" style="border:2px solid #792D89" placeholder="Your Email Address" id="subscriber_email" name="subscriber_email" required> {{-- We'll use the HTML id Global Attribute in jQuery in front/js/custom.js --}}
