                ...
                <div class="col-md-12 grid-margin">
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                            <h3 class="font-weight-bold">@lang('public.edit shipping charges')</h3>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="{{ url('admin/edit-shipping-charges/' . $shippingDetails['id']) }}" method="post"> <!-- If the id is not passed in from the route, this measn 'Add a new Shipping Charge', but if the id is passed in from the route, this means 'Edit the Shipping Charge' --> <!-- Using the enctype="multipart/form-data" to allow uploading files (images) -->
                                ...
                                <div class="form-group">
                                    <label for="0_500g">@lang('public.rate (0-500g)')</label>
                                    <input type="text" class="form-control" id="0_500g" placeholder="@lang('public.enter shipping rate')" name="0_500g" value="{{ $shippingDetails['0_500g'] }}">
                                </div>
                                <div class="form-group">
                                    <label for="501g_1000g">@lang('public.rate (501g_1000g)')</label>
                                    <input type="text" class="form-control" id="501g_1000g" placeholder="@lang('public.enter shipping rate')" name="501g_1000g" value="{{ $shippingDetails['501g_1000g'] }}">
                                </div>
                                <div class="form-group">
                                    <label for="1001_2000g">@lang('public.rate (1001g-2000g)')</label>
                                    <input type="text" class="form-control" id="1001_2000g" placeholder="@lang('public.enter shipping rate')" name="1001_2000g" value="{{ $shippingDetails['1001_2000g'] }}">
                                </div>
                                <div class="form-group">
                                    <label for="2001g_5000g">@lang('public.rate (2001g-5000g)')</label>
                                ...
                                <div class="form-group">
                                    <label for="above_5000g">@lang('public.rate (Above 5000g)')</label>
                                    <input type="text" class="form-control" id="above_5000g" placeholder="@lang('public.enter shipping rate')" name="above_5000g" value="{{ $shippingDetails['above_5000g'] }}">
                                </div>
