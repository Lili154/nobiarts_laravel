                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{ url('admin/add-edit-category') }}" style="max-width: 150px; float: right; display: inline-block" class="btn btn-block btn-primary">@lang('public.add category')</a>
                            ...
                            <div class="table-responsive pt-3">
                                ...
                                <table id="categories" class="table table-bordered"> {{-- using the id here for the DataTable --}}
                                    <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>@lang('public.category name')</th>
                                            <th>@lang('public.parent category')</th> {{-- Through the relationship --}}
                                            <th>@lang('public.parent section')</th> {{-- Through the relationship --}}
                                            <th>URL</th>
